...
echo sbatch --parsable sbatch_wrapper_allfolds.sh --exp-path ${SCRATCH}/exp_results/DIETNETWORK/1000G/remove_largest_attr_enc_0_baseline_all_folds \
...
train_id=$(sbatch --parsable sbatch_wrapper_allfolds.sh --exp-path ${SCRATCH}/exp_results/DIETNETWORK/1000G/remove_largest_attr_enc_0_baseline_all_folds \
                                                        --exp-name "remove_attr_exp_0" \
                                                        --dataset "dataset-0.npz" \
                                                        --embedding "embedding-0.npz" \
                                                        --epochs 4000 \

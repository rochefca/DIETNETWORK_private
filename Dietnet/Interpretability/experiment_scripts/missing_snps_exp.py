...
def main():
    ...
    miss_percent_list = args.miss_percent_list
    ...
    if task == 'classification':
        ...
        for i in miss_percent_list:
            f_str += '_'+str(i)
        #results_filename = 'missing_data_simulations_fold_'+str(fold)+'_'+f_str+'.txt'
        results_filename = 'missing_data_simulations_fold_'+str(fold)+'.txt' # dont include info about thresholds anymore!
